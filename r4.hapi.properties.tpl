...
server_address=http://server-r4:8080/hapi-fhir-jpaserver/fhir/
...
datasource.url=jdbc:mysql://dev-next-smartonfhir-db.cvl10wwmtplv.us-east-2.rds.amazonaws.com:3306/r4?useSSL=false&logger=com.mysql.jdbc.log.Log4JLogger&profileSQL=true
